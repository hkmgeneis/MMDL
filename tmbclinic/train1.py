...
tb = SummaryWriter('/home/ubuntu/miniconda3/predictor/runs/')  # 改动1


def train_model(model, criterion, optimizer, scheduler, dataloaders, dataset_sizes, num_epochs=20, cnv=True):
    since = time.time()
    ...
    if cnv:
        cnv_feature=pd.read_csv('/data/hkm/HEpreTMB/label/clinic/top5.csv')  # 改动2
