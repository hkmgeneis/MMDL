...
import numpy as np
import pandas as pd
y_pred0=np.load('/home/ubuntu/hkm/results/tmb5/top20/top201/y_pred_0.npy')
y_pred1=np.load('/home/ubuntu/hkm/results/tmb5/top20/top201/y_pred_1.npy')
...
np.save("/home/ubuntu/hkm/results/tmb5/top20/top201/pred.npy",predict)

y_true0=np.load('/home/ubuntu/hkm/results/tmb5/top20/top201/y_true_0.npy')
y_true1=np.load('/home/ubuntu/hkm/results/tmb5/top20/top201/y_true_1.npy')
...
true=np.array(true)
np.save("/home/ubuntu/hkm/results/tmb5/top20/top201/true.npy",true)
...
plt.show()
plt.savefig('/home/ubuntu/hkm/results/tmb5/top20/top201/cm-tmb550t20.svg')
